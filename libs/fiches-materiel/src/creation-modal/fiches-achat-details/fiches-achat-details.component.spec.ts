...
describe('FichesAchatDetailsComponent', () => {
  ...
  it('should have seriesExist property', () => {
    fixture = TestBed.createComponent(FichesAchatDetailsComponent);
    component = fixture.componentInstance;
    component.seriesExist = true;
    expect(component.seriesExist).toBeDefined();
    expect(typeof component.seriesExist).toBe('boolean');
  });
  ...
  class TestHostComponent {
    @ViewChild(FichesAchatDetailsComponent)
    public FichesAchatDetailsComponent: FichesAchatDetailsComponent;
  }
